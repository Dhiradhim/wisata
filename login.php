                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                <a class="text-center"> <h4>Wisata</h4></a>
                                ...
                                <p class="mt-5 login-form__footer">Belum punya akun? <a href="register.php" class="text-primary">Daftar</a> sekarang</p>
                            </div>
                        </div>
                    </div>
                </div>
...
{  
    ...
    $run=mysqli_query($con, "select * from login WHERE username='$username' AND password='$password'");  
	$xrun = mysqli_fetch_assoc($run);
    if(mysqli_num_rows($run) > 0)  
    {  
			echo "<script>window.open('index.php','_self')</script>";  
			$_SESSION['id_user']=$xrun['id_user'];
    }  
    else  
    {  
